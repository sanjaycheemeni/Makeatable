                  ...
                  children: [
                    ...
                    GestureDetector(
                        ...
                        child: Container(
                          ...
                          width: 180,
                          height: 60,
                          child: Text("Disabled",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                        )),
                  ],
                ),
              ),
                          ...
                          children: [
                            TopRatedCard(
                              onclick: (){
                                ...
                                foodName: 'Biriyani',
                                price: '₹200',
                                imageLocation: 'images/Biriyani.webp'),
                            TopRatedCard(
                              onclick: (){
                                ...
                                foodName: 'Pizza',
                                price: '₹150',
                                imageLocation: 'images/pizza.jpg'),
                          ],
                        ),
                        SizedBox(
                          height: 10,
                          ...
                          children: [
                            TopRatedCard(
                              onclick: (){
                                ...
                                price: '₹80',
                                imageLocation: 'images/Chhicken Fry.jpg'),
                            TopRatedCard(
                             onclick: (){
                                ...
                                price: '₹120',
                                imageLocation: ('images/French Fry.jpg'),
                            ), ],
                        ),
                        SizedBox(
                          height: 10,
                          ...
                          children: [
                            TopRatedCard(
                               onclick: (){
                                ...
                                price: '₹50',
                                imageLocation: 'images/Masala Dosa.jpg'),
                            TopRatedCard(
                              onclick: (){
                                ...
                                price: '₹70',
                                imageLocation: 'images/Cheeseburger.jpg'),
                          ],
                        ),
                        SizedBox(
                          height: 10,
                        ...
                        Row(
                          children: [
                            ...
                            onclick: (){
                                ...
                                price: '₹160',
                                imageLocation: 'images/Beef Chilli.jpg'),
                            TopRatedCard(
                              onclick: (){
                                ...
                                foodName: 'Beef Fry',
                                price: '₹90',
                                imageLocation: 'images/BeefFry004.jpg'),
                          ],
                        ),
                      ])),
            ],
